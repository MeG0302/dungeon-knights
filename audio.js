...
class AudioManager {
    ...
    loadSounds() {
        ...
        this.sounds = {
            ...
            // Reward claiming sounds
            reward_claim_start: () => this.zzfx(0.3, 0, 440, .02, .1, .2, 1, 1.5, 0, 0, 0, 0, 0, 0, 0, 0, 0, .6, .05),
            reward_claim_success: () => this.zzfx(0.5, 0, 880, .03, .2, .4, 1, 3, 0, 0, 0, 0, 0, 0, 0, 0, 0, .9, .1),
            coin_cascade: () => this.zzfx(0.3, 0.1, 1047, .01, .08, .15, 1, 2.5, 0, 0, 0, 0, 0, 0, 0, 0, 0, .7, .03),
            blockchain_confirm: () => this.zzfx(0.35, 0, 523, .05, .3, .4, 0, 1.8, 0, 0, 0, 0, 0, 0, 0, 0, 0, .75, .08),
