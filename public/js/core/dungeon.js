        ...
        for (let i = 0; i < nodeCount; i++) {
            ...
            if (foundValid) {
                ...
                if (type === 'monster' && this.config.monsters && this.config.monsters.length > 0) {
                    ...
                    monsterImage = `/assets/images/monsters/${this.config.monsterFolder}/${randomMonster}`;
                }
...
class DungeonRenderer {
    ...
    loadDecorationSprites() {
        const sprites = {
            'crypts': '/assets/images/obstacles/Crypt_decorations_pixel_art_asset_2K_202609041548.jpeg',
            'mines': '/assets/images/obstacles/Underwater_goblin_mines_pixel_art_2K_202609041548.jpeg',
            'temple': '/assets/images/obstacles/Pixel_art_temple_decorations_2K_202609041548.jpeg',
            'magma': '/assets/images/obstacles/Pixel_art_magma_chamber_decorations_2K_202609041548.jpeg',
            'void': '/assets/images/obstacles/Pixel_art_void_rift_decorations_2K_202609041548.jpeg'
        };
        ...
        Object.entries(DUNGEONS).forEach(([dungeonKey, config]) => {
            if (config.monsters && config.monsters.length > 0) {
                config.monsters.forEach(monsterFile => {
                    const monsterPath = `/assets/images/monsters/${config.monsterFolder}/${monsterFile}`;
