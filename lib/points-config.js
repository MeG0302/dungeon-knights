 ...
 *
 * **A third kind of task is neither.** The waitlist one (`proof: 'visit'`) pays on the claim with
 * nothing behind it at all — no verifier, no review window — because there is genuinely nothing to
 * ask about it. Its own proof value is what keeps it from inheriting the follow's mode.
 *
...
export const ONE_TIME_TASKS = [
    ...
    },
    {
        ...
        blurb: 'Add your email and wallet to the Genesis waitlist, then claim. This one runs no check \u2014 it pays on your word.',
    },
