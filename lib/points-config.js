...
export const QUOTE_CHECK_NOTE = 'X is asked two things about the post you paste: that the account bound to your wallet wrote it, and that it tags @{handle}. X cannot see which post you quoted, so quote the one on the card.';
...
export const ONE_TIME_POSTS = [
    {
        ...
        cta: 'Open the teaser',
        hint: 'Quote the teaser that introduces Arya and the Points Program, add your own words, and tag @{handle}.',
    },
    {
        id: 'quote-map',
...
export const ONE_TIME_TASKS = [
    {
        ...
        blurb: 'Follow @{handle} on X, then claim. Follows are verified manually, so points are credited after review, usually within 30\u201345 minutes. Pays once per X account, ever.',
        blurbChecked: 'Follow @{handle} on X, then claim. X tells us when someone follows us, so this one is checked against X\u2019s own record. Pays once per X account, ever.',
    },
