...
export const ONE_TIME_TASKS = [
    {
        ...
        reward: 500,
        // No verifier runs on this one. It is a claim, and the card is written like one.
        proof: 'claim',
        cta: 'Follow @{handle}',
        url: 'https://x.com/{handle}',
        blurb: 'Follow @{handle} on X, then claim. No check runs on this one — X\u2019s public embed cannot see who you follow, so it is taken on your word, and it pays once per X account, ever.',
