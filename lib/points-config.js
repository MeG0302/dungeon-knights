 ...
 * counting the same days. The default is the first production deploy of this program.
 */
export const PROGRAM_DAY_ONE = (process.env.X_PROGRAM_DAY_ONE || '2026-09-21').trim();
