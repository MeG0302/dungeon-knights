...
/**
 * Claim a one-time task (`follow`).
 *
 * There is no link to hand over, and nothing is verified: the task list says which of its entries
 * are claims, and the server pays a claim once per wallet and refuses it without a bound X account.
 */
