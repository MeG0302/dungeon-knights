...
export const CONTRACTS_SECTION = {
    ...
    sub: `The contracts the game runs on, on ${CHAIN.name}. You never need to look at any of this to play — it is here for the reader who would rather see for themselves.`,
    /**
...
export const FOOTER = {
    ...
    links: [
        ...
        { label: 'Source', href: LINKS.code, external: true },
    ],
};
