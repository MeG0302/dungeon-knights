...
export const HASH_POWER_MIN = 1;
export const HASH_POWER_MAX = 100;
 ...
 *
 * The spec listed the Mythic capsule as "28% Mythic + 2% Mythic"; these tables are
 * corrected to sum to exactly 100. The odds are shown in the UI rather than kept as a
 * surprise, because players compare them to the Summoning Chamber's price.
 */
