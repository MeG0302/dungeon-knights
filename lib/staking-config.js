...
/**
 * The summonable collection's hard ceiling.
 *
 * Genesis is fixed at 1,024 by design; Knights are minted by capsules and would otherwise
 * be uncapped, which makes their dilution unbounded and therefore unpublishable. A cap
 * turns "how bad can it get" into a number a buyer can check: at 10,000 Knights the two
 * Knights lines pay about 5% of the reference table, and that floor is asserted.
 */
export const KNIGHTS_CAP = 10_000;
 ...
 * 5,000 as the collection fills toward `KNIGHTS_CAP`.
 */
