    ...
    return {
        ...
        claimedNote: !claimed
            ...
            : (claimedProof === 'webhook'
                ...
                : (claimedProof === 'visit'
                    // The receipt for a task nothing checked. It says so, where the follow's says a
                    // review decided it — the foot of the card is the only place that answers "was
                    // anything looked at", and the answer is different per task.
                    ? 'nothing was checked'
                    : (record.review === true
