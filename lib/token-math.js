...
import {
    CAPSULES_PER_WEEK, CAPSULE_TYPES, HASH_POWER_BANDS, KNIGHTS_CAP,
...
import {
    ...
    knightsMaximumBurnPerDay, knightsPayoutAtCap, lineBudgets, lineShares, referenceBurnPerDay,
 ...
 * lines — but it becomes *bounded and published*: the collection has a ceiling, the open
 * price rises toward it, and the per-Knight floor at the cap is a computed figure rather
...
export {
    DNG_SUPPLY, GENESIS_DAILY_CAPACITY, GENESIS_DAILY_RUNS, GENESIS_REWARD_PER_CLEAR,
    KNIGHTS_CAP, MIN_WEEKS, REWARD_VAULT_DNG, STAKING_SHARE_OF_DUNGEON, SUMMON_PRICE_DNG,
    ...
    worstCaseBurnPerDay, knightsPayoutAtCap, capsuleBreakEvenMinted,
...
export function headline() {
    return {
        ...
        knightsPayoutAtCapRatio: knightsPayoutAtCap().ratioOfReference,
        ...
        capsuleYearsToFill: KNIGHTS_CAP / (CAPSULES_PER_WEEK * 52),
    };
}
