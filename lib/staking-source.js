...
// The floor for a preview knight's power: high enough that tickets and shares read as
// interesting numbers rather than zeros.
const PREVIEW_POWER_MIN = 18;
...
function previewGenesis(address, nowMs) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        knights.push({
            ...
            hashPower: PREVIEW_POWER_MIN + Math.floor(rand() * (HASH_POWER_MAX - PREVIEW_POWER_MIN)),
        });
    }
