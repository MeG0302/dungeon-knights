...
//
//   COUNT_KEY — **how many people are in line.** This is the number the landing page prints, so it
//               has to fall when an entry is removed; otherwise the page advertises a queue that is
//               not there. (Measured: after clearing three test entries the page still said 5.)
...
// -------------------------------------------------------------------- the interface
/** How many people are in line — the number the landing page shows. */
