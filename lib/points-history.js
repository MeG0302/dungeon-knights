...
export function describeEarn(reason) {
    ...
    // The one row that is negative. Named rather than humanised — the generic path would print
    // "Redeem Spin", which says what happened and not what it was: a spin of the wheel, paid for.
    if (raw === 'redeem_spin') return 'Redeem · knights\u2019 wheel spin';
